...
export const INITIAL_ADSTERRA_ADS: Advertisement[] = [
  {
    id: 'ad-2-adsterra-container',
    name: 'AD 2 — Adsterra Content Container',
    network: 'Adsterra',
    format: 'container',
    ...
    code: `<script async="async" data-cfasync="false" src="https://pl31331226.profitableratecpmnetwork.com/70e37b03ade96f3849b83b7f9832bfc2/invoke.js"></script>\n<div id="container-70e37b03ade96f3849b83b7f9832bfc2"></div>`,
    createdAt: '2026-09-14T00:00:00.000Z',
    updatedAt: '2026-09-14T00:00:00.000Z'
  },
  {
    id: 'ad-3-banner-468x60',
    name: 'AD 3 — 468×60 Banner',
    network: 'Adsterra',
    format: 'banner_468x60',
    placement: 'top_banner',
    devices: 'all', // responsive: suitable desktop / tablet
    width: 468,
    height: 60,
    enabled: true,
    priority: 3,
